...
def init():
  ...
  v26 = u"微信自动加群群功能已关，请使用我们的网站【北美加群小助手jogchat.com】加入北美各地区Facebook群组。谢谢😊"
  vT =v1+v00+v1+v2+v3+v4+v5+v6+v7+v8+v9+v10+v11+v12+v13+v14+v15+v16+v17+v18+v19+v20+v21+v22+v23+v24+v25
  usersDict = {}
  admins=[] 
